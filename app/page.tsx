  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="bg-slate-50 dark:bg-slate-900 py-20 sm:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:max-w-none">
              ...
              <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
                {recentPosts.map((post) => (
                  <article key={post.id} className="group relative flex flex-col">
                    <div className="relative rounded-2xl bg-white dark:bg-slate-800 p-8 shadow-md ring-1 ring-slate-900/5 dark:ring-slate-700/50 transition hover:shadow-lg">
                      <div className="flex items-center gap-3 mb-4">
                        <span className="inline-flex items-center rounded-full bg-blue-50 dark:bg-blue-950 px-2 py-1 text-xs font-medium text-blue-700 dark:text-blue-300 ring-1 ring-inset ring-blue-700/10 dark:ring-blue-400/20">
                          {post.category}
                        </span>
                      ...
                      <div className="mt-6 flex items-center gap-x-4 border-t border-slate-900/5 dark:border-slate-700/50 pt-6">
          ...
          <div className="py-16">
            ...
            <nav className="mt-10 text-sm" aria-label="quick links">
              <div className="-my-1 flex justify-center gap-x-6">
                <Link href="/" className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-300">
                  Home
                </Link>
                <Link href="/about" className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-300">
                  About
                </Link>
                <Link href="/blog" className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-300">
                  Blog
                </Link>
                <Link href="/contact" className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-300">
                  Contact
                </Link>
              </div>
            </nav>
          </div>
          <div className="flex flex-col items-center border-t border-slate-400/10 dark:border-slate-700/50 py-10 sm:flex-row-reverse sm:justify-between">
            <div className="flex gap-x-6">
              <Link href="#" className="group" aria-label="Hope Blog on X">
                <svg className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700 dark:fill-slate-400 dark:group-hover:fill-slate-300" aria-hidden="true" viewBox="0 0 24 24">
